...
public class GeneticAlgorithm {
    ...
    void culling2() {
        ...
        ArrayList<Integer> invalidIndex = popPuz2.getInvalidTowerIndex();
        System.out.println("InvalidIndex size: " + invalidIndex.size());
        System.out.println("Pop size at culling: " + popPuz2.population.size());
        System.out.println("Pop at culling: " + popPuz2.population.toString());
        for (int i = 0; i < invalidIndex.size(); i++) {
            popPuz2.population.remove(invalidIndex.get(i));
        }
        System.out.println("Pop size after remove in cull: " + popPuz2.population.size());
    ...
    ArrayList<Integer> selection2() {
        ...
        int index1 = -1;
        int index2 = -1;
        int totalScore = popPuz2.getTotalScore();
        ArrayList<Float> probabilityList = new ArrayList<>();
        float totalProb = 0;
        System.out.println("Pop size in selection: " + popPuz2.population.size());
        for(int i = 0; i < popPuz2.population.size(); i++) {
            System.out.println("Individual score in selec: " + Math.abs(popPuz2.population.get(i).getScore()));
            System.out.println("Total score in selec: " + totalScore);
            float prob = (float) Math.abs(popPuz2.population.get(i).getScore()) / (float)totalScore;
...
//            System.out.println("First three best fitness score for this generation is " + popPuz1.get(popPuz1..getFittestIndex()).getScore());
    ...
    void runGeneticAlgorithm2() {
        while(genCount < 300
            ...
            //Remove the bottom from the current pop before selection (Culling)
            culling2();
            System.out.println("Pop size after cull: " + popPuz2.population.size());
